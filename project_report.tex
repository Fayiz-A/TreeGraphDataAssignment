...
\begin{enumerate}
    \item Download the \texttt{ontario\_road\_network.geojson} file shared via one drive shared link- \url{https://utoronto-my.sharepoint.com/:u:/g/personal/fayiz_ali_mail_utoronto_ca/IQDhtKu1wot5Q4vNBEP51VLGAetT_JvGxjJON6AUmDvsyq4?e=ZateLM} (requires University of Toronto login), unzip it, and place \texttt{ontario\_road\_network.geojson} at the project's root directory.
